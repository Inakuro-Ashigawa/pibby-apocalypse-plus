...
public var shader = new CustomShader("Pibbey/GreenReplacementShader");
...
function update(elapsed){
    ...
    if(fullPibbyHealthbar)
        pibbyHealthbar.animation.play('100Percent'); 
    else
        pibbyHealthbar.animation.play((snap(damagePercent*100, 2.5)) + "Percent"); 
}
